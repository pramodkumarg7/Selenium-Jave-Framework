...
public class ExplicitWaiting extends BaseMethod
{
	...
	public static WebDriverWait s;
	
	public static void check(WebElement element, int time) 
	{
		System.out.println("hiiiiiiiiiiiiii");
		s = new WebDriverWait(driver, time);
		s.until(ExpectedConditions.elementToBeClickable(element));
